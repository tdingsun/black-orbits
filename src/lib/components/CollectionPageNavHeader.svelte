...
<div
	...
	class="border-primary-text bg-bg fixed top-0 z-9999 hidden sm:flex w-dvw flex-col  border-b  items-start justify-between gap-8  p-4 pb-3 transition-[top] duration-500 sm:flex-row"
>
